...
NPC_IMAGES = {
    ...
    'image_treant': {
        ...
        'left': pygame.image.load(os.path.join(path, "resources/graphics/npc", "treant_left.png")),
        'right': pygame.image.load(os.path.join(path, "resources/graphics/npc", "treant_right.png"))
    },
    'image_unicorn': {
