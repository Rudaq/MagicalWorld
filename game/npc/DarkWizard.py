...
class DarkWizard(Npc):
    def __init__(self, name, side, mana, life, images, artifacts, quests, x, y, pos, groups, collision_sprites):
        ...
        healing_potion_image = pygame.image.load(os.path.join(path, "resources/graphics/artifacts", "healing_potion.PNG")).convert_alpha()
        ...
        dark_wizard_attack = pygame.image.load(os.path.join(path, "resources/graphics/particles", "dark_wizard_attack.PNG")).convert_alpha()
