...
class BigMonke(Npc):
    def __init__(self, name, side, mana, life, images, artifacts, quests, x, y, pos, groups,
        ...
        self.can_talk = True
        gem_image = pygame.image.load(os.path.join(path, "resources/graphics/artifacts", "dwarven_gem.PNG")).convert_alpha()
        ...
        heart_image = pygame.image.load(os.path.join(path, "resources/graphics/artifacts", "monke_heart.PNG")).convert_alpha()
        ...
        big_monke_attack = pygame.image.load(
            os.path.join(path, "resources/graphics/particles", "banana.PNG")).convert_alpha()
