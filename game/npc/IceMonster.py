...
class IceMonster(Npc):
    def __init__(self, name, side, mana, life, images, artifacts, quests, x, y, pos, groups, collision_sprites):
        ...
        self.can_talk = True
        blood_image = pygame.image.load(os.path.join(path, "resources/graphics/artifacts", "yeti_blood.PNG")).convert_alpha()
        tusk_image = pygame.image.load(os.path.join(path, "resources/graphics/artifacts", "yeti_tusk.PNG")).convert_alpha()
        skin_image = pygame.image.load(os.path.join(path, "resources/graphics/artifacts", "ice_monster_skin.PNG")).convert_alpha()
        ...
        ice_image = pygame.image.load(os.path.join(path, "resources/graphics/particles", "small_cube.PNG")).convert_alpha()
