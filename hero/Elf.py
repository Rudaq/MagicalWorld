...
from artifacts.SpellClass import SpellClass
from hero.Character import Character

SPRITE_SIZE = 50
path = os.getcwd()
earth = pygame.image.load(os.path.join(path, "resources", "earth2.PNG"))
healing = pygame.image.load(os.path.join(path, "resources", "healing_spell.PNG"))
arrow = pygame.image.load(os.path.join(path, "resources", "arrow.PNG"))
